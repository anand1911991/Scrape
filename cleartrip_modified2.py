...
completeName = os.path.join(os.path.dirname(__file__), '/cleartrip_patna.xls')
#print completeName
completeName = 'cleartrip_patna.xls'
...
browser.get("http://www.cleartrip.com/hotels/results?city=Patna&state=Bihar&"
            "country=IN&area=&poi=&hotelId=&hotelName=&dest_code=35762&chk_in=30%2F07%2F2015&"
            "chk_out=31%2F07%2F2015&adults1=1&children1=0&num_rooms=1")
browser = scrollDown(browser,35)
...
for each_container in container:
    ...
    hotel_name_link = basic_info.find_element_by_css_selector("h2.truncate.span.span24 > a")
