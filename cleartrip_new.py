...
completeName = os.path.join(os.path.dirname(__file__), '/cleartrip.xls')
print (completeName)
completeName = 'cleartrip.xls'
book.save(completeName)
# path = 'C:/Users/lenovo-pc/Desktop/'
# completeName = os.path.join(path, 'cleartrip.xls')
...
browser.get("http://www.cleartrip.com/hotels/results?dest_code=&state=West%20Bengal&country=IN&city=Kolkata&chk_in=02/06/2015&chk_out=03/06/2015&adults1=1&adults=1&children1=0&num_rooms=1")
